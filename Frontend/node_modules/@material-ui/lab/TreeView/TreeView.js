...
var TreeView = React.forwardRef(function TreeView(props, ref) {
  ...
  var addNodeToNodeMap = function addNodeToNodeMap(id, childrenIds) {
    ...
    nodeMap.current[id] = (0, _extends2.default)((0, _extends2.default)({}, currentMap), {}, {
      children: childrenIds,
      id: id
    });
    childrenIds.forEach(function (childId) {
      var currentChildMap = nodeMap.current[childId];
      nodeMap.current[childId] = (0, _extends2.default)((0, _extends2.default)({}, currentChildMap), {}, {
        parent: id,
        id: childId
      });
    });
      ...
      if (map) {
        if (map.parent) {
          ...
          if (parentMap && parentMap.children) {
            ...
            newMap[map.parent] = (0, _extends2.default)((0, _extends2.default)({}, parentMap), {}, {
